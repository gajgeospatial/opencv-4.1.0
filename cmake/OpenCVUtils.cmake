...
macro(__ocv_push_target_link_libraries)
  if(NOT TARGET ${target})
    ...
    message ("Setting Link " ${target} " "  ${ARGN})
    if(NOT ${target} STREQUAL "opencv_test_cudev")
      target_link_libraries(${target} ${ARGN})
    else()
       message("Skipping " ${target})
       string(REPLACE "LINK_PRIVATEPRIVATE" "LINK_PRIVATE" NARGN ${ARGN})
       message("Replaced " ${NARGN})
#       target_link_libraries(${target} ${NARGN})
#       message ("Set Link " ${target} ${NARGN})
    endif()
  endif()
endmacro()
