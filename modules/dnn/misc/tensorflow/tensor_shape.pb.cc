...
::google::protobuf::internal::DescriptorTable descriptor_table_tensor_5fshape_2eproto = {
  ...
  "tensor_shape.proto", &assign_descriptors_table_tensor_5fshape_2eproto, 231,
};
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("opencv_tensorflow.TensorShapeProto.Dim.name");
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::opencv_tensorflow::TensorShapeProto_Dim::_InternalParse;
          object = msg->add_dim();
